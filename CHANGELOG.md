...
- Configurable Claude command presets, including unsafe execution toggle for power users
- Built-in desktop notification module and optional monitoring adapters for sessions, tools, and terminals

### Improvements

- Smarter terminal visibility checks when sending context across tabs
- Native and Snacks providers gain anti-flicker handling and reduced scrollback for stability
