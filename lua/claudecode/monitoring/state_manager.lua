...
local function is_valid_transition(from_state, to_state)
  local valid_transitions = {
    [M.States.DISCONNECTED] = { M.States.IDLE },
    [M.States.IDLE] = { M.States.EXECUTING, M.States.DISCONNECTED, M.States.INTERRUPTED },
    [M.States.EXECUTING] = { M.States.IDLE, M.States.DISCONNECTED, M.States.INTERRUPTED },
    [M.States.INTERRUPTED] = { M.States.IDLE, M.States.EXECUTING, M.States.DISCONNECTED }
  }
